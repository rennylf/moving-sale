...
// —— 全局信息 —— //
const CONFIG = {
  title: "跨省搬家清仓 · 比亚迪东区工友请进",
  subtitle: "因跨省工作调动，2024 年 9 月后陆续购置的寝室好物低价转让 / 免费赠送。主要面向比亚迪东区宿舍及周边工友，欢迎自提、随时验货。",
  purchaseNote: "📦 所有物品均为 2024 年 9 月以后陆续购置，使用时长最长不超过 2 年，物品均为正常使用、无明显损坏，欢迎当面验货～",
  wechat: "RyanGrant",                                          // 你的微信号
  wechatQr: "images/wechat-qr.png",                             // 微信二维码（PNG）
  location: "深圳市坪山区比亚迪东区宿舍 D6 栋（自提）",          // 取货地点
  pickupTime: "工作日 18:00 之后 / 周末全天",                   // 看货取货时间
  note: "主要面向比亚迪东区宿舍及周边工友，自提方便、当面验货；大件支持协助搬到楼下。免费物品先到先得，欢迎随时来取～"
};
